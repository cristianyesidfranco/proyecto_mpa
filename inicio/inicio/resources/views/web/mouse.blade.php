        ...
        <div class="row">
            @foreach($mouses as $mouse)    
                ...
                <div class="col-md-4">
                    <div class="card">
                    @if($mouse->file)
                        <img src="{{$mouse->file}}" class="img-responsive">
                    @endif
                        <div class="card-body">
                        <a class="nav-link" href="#"> {{$mouse->nombre_producto}}</a>
                        <a class="nav-link" href="#">{{$mouse->Categoria->nombre_categoria}}</a>
                            
                            <br>
                             
                            $ {{$mouse->precio_unitario}}
                            <br>
